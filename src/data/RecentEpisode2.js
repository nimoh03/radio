import bannerImg from "../images/episode-card-banner-2.png";

const RecentEpisodeData = [
    {
        id: 1,
        title: "Innovation Insights: Diving Deep into Future Tech Trends",
        host: {
            hostName: "Devon Lane",
            hostLink: "/host-details",
        },
        time: "4hr 12min",
        audio: " https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3",
        btnText: "Listen Now",
        textLink: "/episode-details",
        episode: "Episode 04",
...
export default RecentEpisodeData