...
const BalanceHistoryFilter = () => {
  ...
  return (
    <div className="d-flex flex-wrap flex-xxl-nowrap align-items-center gap-4">
      ...
      <div>
        <Link to="/user/add-balance" className="bttn-2">
          <span className="fs-xl fw-medium">
            <i className="ti ti-circle-plus"></i>
          </span>
          <span className="text-nowrap fw-semibold">Add Balance</span>
        </Link>
      </div>
